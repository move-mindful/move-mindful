 ...
 *
 *  - **The price is never written down.** It comes from RevenueCat via
 *    <ProductPurchase>, the same as everywhere else. Calls to action link to
 *    the purchase block rather than quoting a figure, so a price change in the
 *    dashboard can't leave stale numbers scattered up the page.
...
const DAY_IMAGES = [
  { src: "/posture/day-1.jpg", alt: "Standing forward fold with hands at the wall" },
  { src: "/posture/day-2.jpg", alt: "Seated with a strap, opening through the chest" },
  { src: "/posture/day-3.jpg", alt: "Kneeling lunge with an overhead reach" },
  { src: "/posture/day-4.jpg", alt: "Kneeling tall on a bolster, spine upright" },
  { src: "/posture/day-5.jpg", alt: "Reclined with the legs lifted over a bolster" },
];
    ...
    >
      ...
      <section className="mx-auto flex max-w-[1140px] flex-col items-center gap-6 px-6 pt-14 text-center sm:px-11 sm:pt-[74px]">
        ...
        <div className="flex max-w-[32em] flex-col gap-4 text-lg leading-relaxed text-[#5B5B72] text-pretty sm:text-[1.3125rem]">
          <p>
            Five follow-along 12-minute routines designed to help you feel less
            stiff, stand taller, and move with more freedom.
          </p>
          <p>
            Improve your mobility, build postural strength, and restore movement
            to the places that feel tight and restricted.
          </p>
        </div>
        <div className="mt-1.5 flex flex-col items-center gap-3.5">
          <a href="#buy" className={ctaCls}>
            Get the Reset
          </a>
      ...
      <section className="mx-auto grid max-w-[1140px] grid-cols-2 gap-3 px-6 pt-9 sm:gap-[18px] sm:px-11 sm:pt-14 lg:grid-cols-4">
        {[
          ...
          ["Start today", "Nothing to schedule. Start with the first one right away."],
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <div className="flex flex-col gap-5">
            <p className="text-[17px] leading-[1.68] text-[#5B5B72] sm:text-[19px]">
              Long periods of sitting and screen time can leave your body feeling
              stiff, achy, and restricted. This 5-Day Reset is designed to
              counteract common sedentary patterns and help your body move more
              freely. Each routine has a specific focus, progressing from
        ...
        <div className="mx-auto grid max-w-[1140px] gap-8 px-6 py-11 sm:px-11 sm:py-20 lg:grid-cols-[380px_minmax(0,1fr)] lg:items-center lg:gap-[60px]">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4 text-base leading-[1.68] text-[#5B5B72] sm:text-lg">
              ...
              <p>
                Ayla is the creator of the Therapeutic Yoga Method and founder of
                Clarity of Heart Yoga Studio in Sedona, AZ. Her mission is to
                help people transform their posture, strength, mobility and
                balance. Her method makes it possible for people of all ages,
                abilities, and levels of fitness to safely discover their body’s
                full potential.
              </p>
              <p>
                ...
                different bodies, abilities, and stages of life. She created the
                Posture &amp; Mobility Reset by organizing the most effective
                movements she teaches in the studio into five simple,
                follow-along routines you can practice from the comfort of your
                home.
              </p>
            </div>
      ...
      {/* ---------------- BUY ---------------- */}
      <section id="buy" className="mx-auto max-w-[1140px] px-6 py-11 sm:px-11">
        <div className="flex flex-col items-center gap-4 rounded-[24px] bg-linear-[120deg,#F4F1FE_0%,#EAF8FC_100%] px-6 py-10 text-center sm:px-10 sm:py-14">
          ...
          <ProductPurchase
            ...
            priceClassName="mt-2 text-[2rem] font-semibold tracking-[-0.02em]"
            buttonClassName={`mt-3 ${ctaCls}`}
          />
      ...
      <div className="w-full border-t border-[#EFEFF5]">
        <div className="mx-auto max-w-[1140px] px-6 py-8 sm:px-11">
          <p className="text-[13px] leading-relaxed text-[#8A8AA0] sm:text-sm">
            This program offers general movement instruction and is not medical
